...
import WithdrawalDetailPanel from "./withdrawal-detail-panel";
...
interface HostWalletShellProps {
  walletType: WalletType;
}

export default function HostWalletShell({ walletType }: HostWalletShellProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-y-auto">
      ...
      <div className="mt-6 min-h-0 flex-1 overflow-y-auto">
        {activeTab === "analytics" ? (
          <WalletBalanceCards walletType={walletType} />
        ) : null}
        ...
        {activeTab === "withdrawals" ? (
          <div className="flex flex-col gap-6">
            ...
            <WithdrawalHistory
              walletType={walletType}
              onSelectWithdrawal={openWithdrawal}
            />
          </div>
        ) : null}
      </div>
