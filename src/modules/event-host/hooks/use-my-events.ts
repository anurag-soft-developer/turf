...
import { EVENT_HOST_QUERY_KEYS } from "../constants/query-keys";
...
export function useInfiniteMyEvents(params: Omit<MyEventsParams, "page"> = {}) {
  ...
  return useInfiniteQuery({
    queryKey: EVENT_HOST_QUERY_KEYS.myEvents(filters),
    queryFn: ({ pageParam }) =>
...
export function useHostEvent(id: string) {
  return useQuery({
    queryKey: EVENT_HOST_QUERY_KEYS.event(id),
...
export function useHostEventStats() {
  return useQuery({
    queryKey: EVENT_HOST_QUERY_KEYS.eventStats,
...
export function useSearchMyEvents(
  ...
  return useQuery({
    queryKey: EVENT_HOST_QUERY_KEYS.myEvents({
