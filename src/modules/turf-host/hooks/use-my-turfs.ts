...
export function useInfiniteMyTurfs(params: Omit<MyTurfsParams, "page"> = {}) {
  ...
  return useInfiniteQuery({
    queryKey: TURF_HOST_QUERY_KEYS.myTurfs(filters),
    queryFn: ({ pageParam }) =>
...
export function useHostTurf(id: string) {
  return useQuery({
    queryKey: TURF_HOST_QUERY_KEYS.turf(id),
...
export function useTurfStats() {
  return useQuery({
    queryKey: TURF_HOST_QUERY_KEYS.turfStats,
...
export function useSearchMyTurfs(
  ...
  return useQuery({
    queryKey: TURF_HOST_QUERY_KEYS.myTurfs({
